...
*/
    ...
    /** @dev Adds a new patient record. */
     function addPatient(string memory _admissionNo, string memory _name, string memory _hospital, string memory _doctor, string memory _prescription)  public 
    ...
    //onlyBy(owner)  //restrict access
    returns (uint, string memory, string memory, string memory, string memory, string memory, address[] memory) {
